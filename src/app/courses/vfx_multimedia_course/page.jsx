export default function VFXMultimediaCoursePage() {
  const modules = [
    'Introduction to VFX & Multimedia',
    ...
    'Green Screen & Chroma Effects',
    'Visual Effects Compositing',
    'Video Editing & Production',
    'Sound Editing & Audio Sync',
  ...
  const features = [
    ...
    'Professional Editing Software Training',
  ...
  return (
    <div className="bg-white text-gray-900">
      {/* SEO Meta Tags */}
      <head>
        <title>VFX & Multimedia Course | ANITIO Information Technology and Skill Development LLP</title>

        <meta
          name="description"
          content="Join the Professional VFX & Multimedia Course at ANITIO Information Technology and Skill Development LLP. Learn video editing, motion graphics, visual effects, animation, Adobe After Effects, Premiere Pro, and multimedia production."
        />

        <meta
          name="keywords"
          content="VFX Course, Multimedia Course, Video Editing Training, Motion Graphics, Adobe After Effects, Premiere Pro, Animation Course, Visual Effects Training"
        />
        ...
        <meta
          property="og:title"
          content="VFX & Multimedia Course - ANITIO Institute"
        />

        <meta
          property="og:description"
          content="Professional VFX & Multimedia Training with Certification and Placement Assistance."
        />
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-black via-purple-800 to-red-700 text-white py-20 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h1 className="text-5xl font-bold leading-tight mb-6">
              Professional VFX & Multimedia Course
            </h1>

            <p className="text-lg mb-6 text-gray-200">
              Learn professional video editing, motion graphics, visual effects,
              multimedia production, and cinematic editing with practical live
              projects and industry tools.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto text-lg">
              This VFX & Multimedia Course is designed for students,
              filmmakers, designers, content creators, freelancers, and media
              professionals who want to build a successful career in multimedia.
            </p>
          </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <p className="text-gray-600">
                  Learn professional VFX & multimedia production with practical hands-on projects.
                </p>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Complete VFX & Multimedia Training Program
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <ul className="space-y-4 text-lg text-gray-300">
              ...
              <li>✔ Live Multimedia Projects</li>
              <li>✔ Latest Editing & VFX Software Training</li>
      ...
      <section className="py-20 px-6 bg-purple-700 text-white text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-5xl font-bold mb-6">
            Build Your Career in VFX & Multimedia
          </h2>

          <p className="text-xl mb-8 text-purple-100">
            Learn professional VFX and multimedia production skills with
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-10">
          <div>
            ...
            <p className="text-gray-400 leading-relaxed">
              ...
              industry-focused multimedia and VFX training programs.
            </p>
          </div>
